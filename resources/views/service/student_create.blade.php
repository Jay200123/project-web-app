...
@csrf
        <div class="user-details">
          ...
          <label for="fname">First Name</label>
            <input type="text" class="form-control" name="fname" value="{{$students->fname}}" readonly/>
          </div>

          <div class="input-box">
          <label for="lname">Last Name</label>
            <input type="text" class="form-control" name="lname" value="{{$students->lname}}" readonly/>
          </div>

          <div class="input-box">
          <label for="section">Course & Section</label>
            <input type="text" class="form-control" name="section" value="{{$students->section}}" readonly/>
          </div>
          ...
          <input type="text" name="email" class="form-control" value="{{$students->user->email}}" readonly>
          </div>
